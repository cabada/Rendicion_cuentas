        ...
        <div class="table-responsive-xl">
            <table class="table table-sm table-hover table-condensed table-bordered table-striped mt-2">
                <tr>
                    ...
                    <td class="text-center align-middle background-table">Horas de capacitación</td>
                    <td class="text-center align-middle background-table">Número de participantes base</td>
                    <td class="text-center align-middle background-table">Número de participantes Honorarios/Itinerarios</td>
