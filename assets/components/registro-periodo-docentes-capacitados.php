<div class="row">
    <div class="col-sm-12">
        ...
        <table class="table table-hover table-condensed table-bordered table-striped white-background">
            <br>
            <tr>
                <td class="centered-table-title">Nombramiento</td>
                <td class="centered-table-title">Cantidad de docentes</td>
                <td class="centered-table-title">Cantidad de docentes no capacitados</td>
                <td class="centered-table-title">Porcentaje de docentes capacitados</td>
