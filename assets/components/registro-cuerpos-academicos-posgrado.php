    ...
    <div class="col-sm-12">
        ...
        <table class="table table-hover table-condensed table-bordered table-striped white-background">
            ...
            <tr>
                ...
                <td class="centered-table-title">Nombre de cuerpo académico</td>
                <td class="centered-table-title">Grado</td>
                <td class="centered-table-title">Estado</td>
                <td class="centered-table-title">Fecha de registro</td>
                <td class="centered-table-title">Fecha de vigencia</td>
