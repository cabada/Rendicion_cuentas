<div class="row">
    <div class="col-sm-12">
        <h2>Registro de programa delfin</h2>
        <caption>
        ...
        <table class="table table-hover table-condensed table-bordered table-striped white-background">
            <br>
            <tr>
                <td class="centered-table-title">Nombre de proyecto</td>
                <td class="centered-table-title">Cantidad de alumnos</td>
                <td class="centered-table-title">Año</td>
                <td class="centered-table-title">Fecha de inicio</td>
                <td class="centered-table-title">Fecha de terminación</td>
