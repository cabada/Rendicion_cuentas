                                ...
                                <div class="form-row">
                                    <div class="col">
                                        <input class="btn btn-danger text-white" type="button" target="_blank" value="Exportar PDF"
                                               onclick= "document.reporte.action = 'assets/components/PHP_Consultas/Registro_Lineas_Investigacion_Posgrado/reportePDF.php';
                                document.reporte.submit()" />

                                        <input class="btn btn-success text-white" type="button" value="Exportar Excel"
                                               onclick= "document.reporte.action = 'assets/components/PHP_Consultas/Registro_Lineas_Investigacion_Posgrado/reporteExcel.php';
                                document.reporte.submit()" />
                                    </div>
                                    ...
                                    <div class="col d-flex justify-content-end">
                                        <select class="form-control col-md-5 anio" id="anio-select" name="anio-select">
                                            ...
                                            <?php
                                            $query = "select distinct year(fecha_creado) as fecha_creado from lineas_investigacion_posgrado order by fecha_creado desc";
                        ...
                        <div class="table-responsive-xl">
                            ...
                            if(isset($_POST['consulta'])){
                                ...
                                if (isset($_POST['consulta_anio'])){
                                 ...
                                 where carreras.NOMBRE_CARRERA LIKE '%$q%' or 
                                 lineas_investigacion_posgrado.NOMBRE_ESPECIALIDAD LIKE '%$q%'
                                 and lineas_investigacion_posgrado.fecha_creado LIKE '%$p%'";
