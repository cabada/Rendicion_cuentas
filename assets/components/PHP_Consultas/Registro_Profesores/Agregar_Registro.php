...
$stmt = $conexion->prepare("insert into profesores(nombre_completo,sexo,grado_estudios,hora_jornada,id_area_academica,id_disciplina,vigencia,area_experiencia,fecha_ingreso) values (?,?,?,?,?,?,?,?,?)");
