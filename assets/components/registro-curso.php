<div class="row">
    <div class="col-sm-12">
        ...
        <table class="table table-hover table-condensed table-bordered table-striped white-background">
            <br>
            <tr>
                <td class="centered-table-title">Nombre de curso</td>
                <td class="centered-table-title">Periodo</td>
                <td class="centered-table-title">Horas de capacitación</td>
                <td class="centered-table-title">Número de participantes base</td>
                <td class="centered-table-title">Número de participantes Honorarios/Itinerarios</td>
