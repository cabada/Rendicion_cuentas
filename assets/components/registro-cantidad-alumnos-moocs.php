                        ...
                        <div class="form-row d-flex">
                            <div class="col">
                                <input class="btn btn-danger text-white" type="button" target="_blank" value="Exportar PDF"
                                       onclick= "document.reporte.action = 'assets/components/PHP_Consultas/Registro_MOOCS_Alumnos/reportePDF.php';
                                ...
                                <input class="btn btn-success text-white" type="button" value="Exportar Excel"
                                       onclick= "document.reporte.action = 'assets/components/PHP_Consultas/Registro_MOOCS_Alumnos/reporteExcel.php';
                                       document.reporte.submit()" />
                            ...
                            <div class="col d-flex justify-content-end">
                                <select class="form-control col-md-5 anio" id="anio-select" name="anio-select">
                                    ...
                                    <?php
                                    $query = "select distinct year(fecha_creado) as fecha_creado from moocs_alumnos order by fecha_creado desc";
